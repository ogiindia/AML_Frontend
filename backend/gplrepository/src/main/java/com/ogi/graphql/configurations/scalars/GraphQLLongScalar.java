...
public class GraphQLLongScalar {
	...
	static {
		Coercing<Long, Long> coercing = new Coercing<Long, Long>() {
			...
			public Long serialize(Object input) throws CoercingSerializeException {
				...
				if (result == null) {
					throw new CoercingSerializeException("Expected type 'Long' but was '" + (input) + "'.");
				}
				return result;
			}
			...
			public Long parseValue(Object input) throws CoercingParseValueException {
				Long result = convertImpl(input);
				if (result == null) {
					throw new CoercingParseValueException("Expected type 'Long' but was '" + (input) + "'.");
				}
				return result;
			}
			...
			public Long parseLiteral(Object input) throws CoercingParseLiteralException {
				...
				throw new CoercingParseLiteralException(
						"Expected AST type 'IntValue' or 'StringValue' but was '" + (input) + "'.");
			}
		...
		INSTANCE = GraphQLScalarType.newScalar().name("Long")
				.description("A universally unique identifier compliant Long Scalar").coercing(coercing).build();
